        ...
        <div className="container mx-auto px-6 lg:px-16 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/contact"
                className="inline-flex items-center gap-2 bg-[#1e40af] hover:bg-[#1d3a9e] text-[#ffffff] font-bold px-8 py-4 rounded transition-all duration-200 hover:shadow-lg hover:shadow-[#1e40af]/30 hover:-translate-y-0.5">
                Get a Free Quote
