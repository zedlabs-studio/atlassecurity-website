  ...
  const contactInfo = [
    {
      ...
      label: 'Phone', value: '+64 22 199 3486', href: 'tel:+64221993486',
    },
    {
    ...
    },
    {
      ...
      label: 'Location', value: 'Auckland, Waikato & Wellington, New Zealand', href: null,
    },
    {
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <motion.div className="lg:w-80 shrink-0"
              ...
              <motion.a variants={fadeUp}
                href="https://wa.me/64221993486" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold px-5 py-3.5 rounded-xl transition-colors duration-200 w-fit mb-8">
              ...
              <motion.div variants={fadeUp} className="bg-white border border-gray-200 rounded-xl p-5 shadow-xs">
                <h3 className="text-sm font-extrabold text-[#0a1628] mb-3 uppercase tracking-wider">What Happens Next</h3>
                <ol className="space-y-3 text-xs text-gray-600">
                  <li className="flex gap-2">
                    <span className="font-bold text-[#1e40af] shrink-0">1.</span>
                    <span><strong>Requirement Audit:</strong> Our operations team reviews your inquiry within 2 business hours.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="font-bold text-[#1e40af] shrink-0">2.</span>
                    <span><strong>Free Site Consultation:</strong> Confidential assessment of site access, risks, and guard hours.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="font-bold text-[#1e40af] shrink-0">3.</span>
                    <span><strong>Transparent Proposal:</strong> Detailed breakdown of COA static guards, patrol schedules, or alarm monitoring rates.</span>
                  </li>
                </ol>
              </motion.div>
            </motion.div>
                  ...
                  <>
                    ...
                    <div className="mb-5">
                      ...
                      >
                        ...
                        <option value="Retail Security">Retail Security Services</option>
                        <option value="Commercial Security">Commercial & Corporate Security</option>
