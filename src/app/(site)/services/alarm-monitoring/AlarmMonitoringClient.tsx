  ...
  benefits: [
    {
      ...
      desc: 'Our dedicated professional monitoring centre watches your property around the clock — every alarm is reviewed by a real operator, not just an automated system.',
    },
    {
      icon: '⚡',
      title: 'Instant Alarm Response',
      desc: 'When an alarm triggers, our response team is dispatched immediately. Average response times are among the fastest in New Zealand.',
    },
    {
      icon: '🎥',
      title: 'CCTV Integration',
      desc: 'We integrate CCTV cameras with your alarm system so operators can visually verify incidents before dispatching — reducing false alarm costs.',
    },
    {
      icon: '🔔',
      title: 'Smart Notifications',
      desc: 'Receive real-time alerts directly to your phone whenever an alarm event occurs, so you always know what\'s happening at your premises.',
    },
  ],
  process: [
    {
      step: '01',
      title: 'Site Survey',
      desc: 'We assess your premises to identify vulnerabilities and determine the optimal placement for alarms and cameras.',
    },
    {
      step: '02',
      title: 'System Design',
      desc: 'Our team designs a fully integrated alarm and monitoring solution tailored to your site layout and risk profile.',
    },
    {
      step: '03',
      title: 'Installation',
      desc: 'Professional installation by our certified technicians with minimal disruption to your operations.',
    },
    {
      step: '04',
      title: 'Live Monitoring',
      desc: 'Your system goes live with 24/7 monitoring from our response centre and ongoing technical support.',
    },
  ],
}

export default function AlarmMonitoringClient() {
  ...
  return (
    <main>
        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <Link href="/contact"
                className="inline-flex items-center gap-2 bg-[#1e40af] hover:bg-[#1d3a9e] text-white font-bold px-7 py-3.5 rounded transition-all duration-200 hover:-translate-y-0.5">
                Get a Free Quote
              ...
              <a href="tel:0800285277"
                className="inline-flex items-center gap-2 border border-white/30 hover:border-white text-white font-semibold px-7 py-3.5 rounded transition-all duration-200">
                Call Now
              </a>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <motion.div className="flex-1"
              initial="hidden" animate={detailInView ? 'visible' : 'hidden'} variants={fadeLeft}>
            ...
            <motion.div className="flex-1"
              initial="hidden" animate={detailInView ? 'visible' : 'hidden'} variants={fadeRight}>
      ...
      <section className="py-24 bg-[#f8f9fa]" ref={benefitsRef}>
        <div className="container mx-auto px-6 lg:px-16">
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-6"
            initial="hidden" animate={benefitsInView ? 'visible' : 'hidden'} variants={stagger}>
            {data.benefits.map((b, i) => (
              <motion.div key={i} variants={cardVariant}
                className="bg-white rounded-xl p-7 border border-gray-100 hover:border-[#1e40af]/30 hover:shadow-md transition-all duration-300 flex gap-5">
      ...
      <section className="py-24 bg-[#0a1628]" ref={processRef}>
        <div className="container mx-auto px-6 lg:px-16">
          <motion.div className="text-center mb-14"
            initial="hidden" animate={processInView ? 'visible' : 'hidden'} variants={fadeUp}>
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"
            initial="hidden" animate={processInView ? 'visible' : 'hidden'} variants={stagger}>
      ...
      <section className="bg-[#1e40af] py-14">
        <div className="container mx-auto px-6 lg:px-16 text-center">
          ...
          <p className="text-blue-200 mb-7">Get a free site assessment and custom security alarm solution quote today.</p>
